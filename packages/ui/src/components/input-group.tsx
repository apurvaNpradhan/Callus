...
import { Button } from "@callus/ui/components/button";
import { Input } from "@callus/ui/components/input";
import { Textarea } from "@callus/ui/components/textarea";
import { cn } from "@callus/ui/lib/utils";
...
function InputGroup({ className, ...props }: React.ComponentProps<"fieldset">) {
  return (
    <fieldset
      ...
      className={cn(
        "group/input-group relative m-0 flex h-8 w-full min-w-0 items-center rounded-none border border-input bg-background p-0 shadow-xs transition-[color,box-shadow] outline-none has-[>textarea]:h-auto dark:bg-input/30",
